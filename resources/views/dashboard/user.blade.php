...
@section('content')
    <main class="min-h-screen bg-slate-50/50 p-4 sm:p-6 lg:p-8 space-y-8">
        <div class="flex flex-col lg:flex-row justify-between lg:items-center gap-4">
            <div>
                ...
                <p class="text-sm text-slate-500 mt-1">
                    Manage your wallet balance, instant pay-ins, and payout settlements.
                </p>
            </div>
            <div class="flex items-center gap-3">
                <button
                    ...
                    <i class="bi bi-download text-base"></i> Statement
                </button>
                <button
                    ...
                    <i class="bi bi-plus-circle text-base"></i> Add Money
                </button>
            </div>
        </div>
        ...
        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-4 gap-5">
            <div
                class="bg-gradient-to-r from-cyan-500 to-cyan-600 text-white rounded-2xl p-5 shadow-md hover:-translate-y-1 transition">
                <div class="flex justify-between items-center">
                    <div>
                        <p class="text-xs opacity-80">Wallet Balance</p>
                        <h2 class="text-2xl font-bold mt-1">₹24,850</h2>
                        <p class="text-xs opacity-80 mt-1">Available</p>
                    </div>
            ...
            <div
                class="bg-gradient-to-r from-green-500 to-emerald-600 text-white rounded-2xl p-5 shadow-md hover:-translate-y-1 transition">
                <div class="flex justify-between items-center">
                    <div>
                        <p class="text-xs opacity-80">Today's PayIn</p>
                        <h2 class="text-2xl font-bold mt-1">₹12,450</h2>
                        <p class="text-xs opacity-80 mt-1">18 Transactions</p>
                    </div>
            ...
            <div
                class="bg-gradient-to-r from-indigo-500 to-violet-600 text-white rounded-2xl p-5 shadow-md hover:-translate-y-1 transition">
                <div class="flex justify-between items-center">
                    <div>
                        <p class="text-xs opacity-80">Today's Payout</p>
                        <h2 class="text-2xl font-bold mt-1">₹8,200</h2>
                        <p class="text-xs opacity-80 mt-1">12 Transactions</p>
                    </div>
                    <i class="bi bi-arrow-up-circle text-3xl"></i>
                </div>
            </div>

            <div
                class="bg-gradient-to-r from-orange-400 to-orange-500 text-white rounded-2xl p-5 shadow-md hover:-translate-y-1 transition">
                <div class="flex justify-between items-center">
                    <div>
                        <p class="text-xs opacity-80">Pending</p>
                        <h2 class="text-2xl font-bold mt-1">₹1,850</h2>
                        <p class="text-xs opacity-80 mt-1">3 Transactions</p>
                    </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
            <div
                class="lg:col-span-2 bg-white rounded-3xl border border-slate-200/80 p-6 shadow-sm hover:shadow-md transition-shadow">
                <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-4 mb-6">
                    <div>
                        <div class="flex items-center gap-2">
                            <h3 class="text-lg font-bold text-slate-800">Transaction Analytics</h3>
                            <span
                        ...
                        <p class="text-xs text-slate-500 mt-1">Daily inflow and outflow metrics (Last 7 Days)</p>
                    </div>
                ...
                <div id="userAnalyticsChart" class="w-full min-h-[300px]"></div>
            </div>

            <div
                class="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-sm hover:shadow-md transition-shadow flex flex-col justify-between">
                <div class="flex items-center justify-between mb-2">
                    <div>
                        <h3 class="text-lg font-bold text-slate-800">Transaction Success</h3>
                        <p class="text-xs text-slate-500 mt-0.5">Performance Breakup</p>
                    </div>
                ...
                <div class="relative flex items-center justify-center my-2">
                    <div id="userSuccessChart" class="w-full"></div>
                </div>
                ...
                <div class="grid grid-cols-3 gap-3">
                    <div class="bg-slate-50 rounded-2xl p-3 text-center border border-slate-100">
                        ...
                        <p class="text-base font-bold text-slate-800">96.0%</p>
                    </div>
                    <div class="bg-slate-50 rounded-2xl p-3 text-center border border-slate-100">
                        <div class="flex items-center justify-center gap-1.5 mb-1">
                        ...
                        <p class="text-base font-bold text-slate-800">3.0%</p>
                    </div>
                    <div class="bg-slate-50 rounded-2xl p-3 text-center border border-slate-100">
                        <div class="flex items-center justify-center gap-1.5 mb-1">
        ...
        <div class="bg-white rounded-3xl border border-slate-200/80 p-6 shadow-sm">
            ...
            <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                <a href="#"
                    ...
                    <p class="font-semibold text-slate-800 text-sm">Add Money</p>
                    <span class="text-xs text-slate-400 mt-0.5 block">Top-up wallet</span>
                </a>
                ...
                <a href="#"
                    ...
                    <span class="text-xs text-slate-400 mt-0.5 block">Transfer to bank</span>
                </a>
                ...
                <a href="#"
                    ...
                    <p class="font-semibold text-slate-800 text-sm">UPI Pay</p>
                    <span class="text-xs text-slate-400 mt-0.5 block">Scan & pay instant</span>
                </a>
                ...
                <a href="#"
                    ...
                    <p class="font-semibold text-slate-800 text-sm">Passbook</p>
                    <span class="text-xs text-slate-400 mt-0.5 block">History log</span>
                </a>
            </div>
        </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            const analyticsOptions = {
                series: [{
                    name: 'PayIn Volume',
                    data: [4200, 6800, 9500, 7100, 11400, 10200, 12450]
                }, {
                    name: 'Payout Volume',
                    data: [2100, 3200, 5400, 4800, 7200, 6100, 8200]
                }],
                chart: {
                    type: 'area',
                    height: 310,
            ...
            new ApexCharts(document.querySelector("#userAnalyticsChart"), analyticsOptions).render();
            ...
            new ApexCharts(document.querySelector("#userSuccessChart"), successOptions).render();
        });
    </script>
@endsection
