...
<header class="h-20 fintech-gradient text-white flex items-center justify-between px-4 sm:px-8 z-20 flex-shrink-0 border-b border-white/10">
  <div class="flex items-center gap-4">
    <button onclick="toggleSidebar()" class="text-white/80 hover:text-white p-2 rounded-xl hover:bg-white/5 transition">
  ...
  <div class="flex items-center gap-3 sm:gap-4">
    ...
    <div class="relative">
      <button onclick="toggleNotificationMenu()" class="w-10 h-10 rounded-full flex items-center justify-center relative hover:bg-white/5 transition text-white/80 hover:text-white">
        <i class="bi bi-bell text-xl"></i>
        <span class="absolute top-2 right-2.5 w-2 h-2 bg-fintechCyan rounded-full"></span>
      </button>
      
      <!-- Popover Menu Box Content -->
      <div id="notificationMenu" class="hidden absolute right-0 mt-3 w-80 sm:w-96 bg-fintechDropdownBg border border-white/10 rounded-2xl shadow-2xl p-4 z-50">
    ...
    <div class="relative">
      <button onclick="toggleProfileMenu()" class="flex items-center gap-3 p-1.5 rounded-xl hover:bg-white/5 transition text-left">
        <div class="w-9 h-9 rounded-xl bg-gradient-to-br from-fintechCyan to-fintechGreen flex items-center justify-center font-bold text-fintechDark text-sm">
          JD
            </div>
      ...
      <div id="profileMenu" class="hidden absolute right-0 mt-3 w-56 bg-fintechDropdownBg border border-white/10 rounded-2xl shadow-2xl p-2 z-50">
        <a href="#" class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-white/70 hover:text-white hover:bg-white/5 transition">
        ...
        <button onclick="processLogout()" class="w-full flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm text-red-400 hover:text-red-300 hover:bg-red-500/10 transition text-left">
