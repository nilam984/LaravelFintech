<aside id="sidebarPanel"
    ...
    <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto custom-scrollbar">
        ...
        <a href="{{ route('scheme') }}"
            class="flex items-center gap-3 px-3 py-2.5 rounded-xl to-transparent text-white  transition duration-200 {{ request()->routeIs('scheme') ? 'bg-fintechCyan text-white' : 'text-white/60 hover:text-fintechCyan' }}">
