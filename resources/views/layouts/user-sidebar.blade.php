...
<aside id="sidebarPanel"
    ...
    <nav class="flex-1 px-4 py-6 space-y-1.5 overflow-y-auto custom-scrollbar">
        ...
        <div class="text-xs font-semibold text-white/30 px-3 mt-6 mb-2 tracking-wider uppercase">Analytics & Assets
        </div>

        <!-- PARENT MENU ITEM: Investment Portfolios -->
        <div class="space-y-1">
            <button onclick="toggleSubmenu(this)"
                class="w-full flex items-center justify-between px-3 py-2.5 rounded-xl text-white/70 hover:text-white hover:bg-white/5 transition duration-200 group">
                <div class="flex items-center gap-3">
            ...
            <!-- CHILD MENU HIERARCHY -->
            <div class="hidden pl-9 pr-2 space-y-1 overflow-hidden transition-all duration-300 submenu-container">
                <a href="#" class="block py-2 text-sm text-white/60 hover:text-fintechCyan transition">Automated
                    Staking</a>
                <a href="#" class="block py-2 text-sm text-white/60 hover:text-fintechCyan transition">Index
                    Funds</a>
                <a href="#" class="block py-2 text-sm text-white/60 hover:text-fintechCyan transition">Risk
                    Analysis</a>
            </div>
        </div>
